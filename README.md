...
```ruby
pod 'KoraIDV', :git => 'https://github.com/badedokun/koraidv-koraidv-ios.git', :tag => 'v1.5.2'
```
...
```swift
dependencies: [
    .package(url: "https://github.com/badedokun/koraidv-koraidv-ios.git", from: "1.5.2")
]
```
